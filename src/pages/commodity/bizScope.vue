...
<template>
  <div>
    <Breadcrumb>
      ...
      <BreadcrumbItem>经营范围</BreadcrumbItem>
    </Breadcrumb>
      <Modal
        title="经营范围信息"
        ...
        :loading="true"
        width="760px">
        <Form ref="formBizScope" :model="formBizScope" :rules="ruleType" :label-width="120">
          <Row :gutter="10">
	        <Col span="11">
	          <FormItem label="名称" prop="businessName">
	            <Input type="text" v-model="formBizScope.businessName" placeholder="请输入名称"></Input>
	          </FormItem>
	        </Col>
	        <Col span="11">
	          <FormItem label="商品类型" prop="typeId">
	          <Select v-model="formBizScope.typeId" placeholder="请选择商品类型">
	            <Option value="1">商品类型A</Option>
	            <Option value="2">商品类型B</Option>
	          </Select>
	          </FormItem>
	        </Col>
	        <Col span="12">
	          <FormItem label="是否有效" prop="status">
	          <RadioGroup v-model="formBizScope.status" type="button">
  ...
  export default {
    data(){
      return {
        ...
        formBizScope: {businessName:'',typeId:'',status:''}
      }
    },
    methods: {
	    doReset(){
	        for(let field in this.formBizScopeSearch){
            	this.formBizScopeSearch[field] = '';
            }
	    },
